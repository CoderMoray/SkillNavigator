export type CompletedInspectionStatus = "completed" | "rejected";
...
export function calculateCompletedInspectionStatus(findings: InspectionFinding[]): CompletedInspectionStatus {
  if (
