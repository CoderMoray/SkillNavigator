...
export const skills = pgTable("skills", {
  ...
  inspectionFailedStages: text("inspection_failed_stages").array().notNull().default([]),
  inspectionFailedMessage: text("inspection_failed_message"),
  inspectionCompletedStages: text("inspection_completed_stages").array().notNull().default([]),
  inspectionSkillspectorStatus: text("inspection_skillspector_status"),
  inspectionVirustotalStatus: text("inspection_virustotal_status"),
  inspectionHalucatchStatus: text("inspection_halucatch_status"),
  uploadedAt: timestamp("uploaded_at", { withTimezone: true }),
  inspectionStartedAt: timestamp("inspection_started_at", { withTimezone: true }),
  inspectionEndedAt: timestamp("inspection_ended_at", { withTimezone: true }),
  ...
  index("skills_inspection_status_idx").on(table.inspectionStatus),
]);
...
export const skillVersions = pgTable("skill_versions", {
  ...
  index("skill_versions_inspection_status_idx").on(table.skillSlug, table.inspectionStatus),
]);
